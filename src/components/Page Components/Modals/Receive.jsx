    ...
    <form className='p-6 gap-4 flex justify-center items-center flex-col w-full' action="">
        ...
        <div className='relative flex flex-col items-start gap-2 w-full'>
            ...
            <div className='outline-none border-none bg-[#F7F7F7] h-[56px] px-4 gap-2 w-full self-stretch flex items-center text-base placeholder:text-[#838385] font-normal leading-6 text-[#000000] rounded-lg'>
                ...
                <IoIosArrowDown onClick={() => setReceiveAssets(prev => !prev)} className={`text-[1.125rem] text-[#151515] font-bold cursor-pointer ${receiveAssets ? `rotate-[180deg] duration-200` : `rotate-0 duration-200`}`} />
            </div>
            {
