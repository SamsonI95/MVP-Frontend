      ...
      >
            ...
            <p
              ...
              className={`${
                sendReceiveModal === "Send"
                  ? ` border-b-2 text-[#2F4EED] border-[#2F4EED]`
                  : ` border-b-2 text-[#9C9C9C] border-transparent`
              } cursor-pointer text-base font-semibold leading-6 pb-2 gap-2`}
            >
              Send
            </p>
            <p
        ...
        {sendReceiveModal === "Send" ? (
          ...
          <Receive
            ...
            setReceiveAssets={setReceiveAssets}
