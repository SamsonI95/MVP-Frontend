...
const NotFound = () => {
  ...
  return (
    <section className='w-full h-screen flex flex-col justify-center items-center text-center gap-[16px]'>
        ...
        <Link className='bg-[#2F4EED] px-4 py-2 rounded-lg text-white h-[3.5em] gap-[40px] font-semibold flex justify-center items-center cursor-pointer' onClick={handleNavigate}>Go Back Home</Link>
    </section>
  )
}
